...
- [Day 01 — 인프라 설계 및 환경 세팅](#-day-01--인프라-설계-및-환경-세팅)
- [Day 02 — 가상화 환경 구성 (ESXi + vCenter)](#-day-02--가상화-환경-구성-esxi--vcenter)
- [Day 03 — 공유 스토리지 구성 (iSCSI / NFS)](#-day-03--공유-스토리지-구성-iscsi--nfs)
- [Day 04 — 클러스터 고가용성 (HA / DRS)](#-day-04--클러스터-고가용성-ha--drs)
- [Day 05 — 서비스 배포 및 운영](#-day-05--서비스-배포-및-운영)

---

## 🗓️ Day 01 — 인프라 설계 및 환경 세팅
...
## 🖥️ Day 02 — 가상화 환경 구성 (ESXi + vCenter)
